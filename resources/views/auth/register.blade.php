        ...
        <div class="flex-1 h-full max-w-md mx-auto overflow-hidden bg-white rounded-lg shadow-xl">
            <div class="flex flex-col overflow-y-auto">
                <div class="h-32 pt-6 -mb-6 md:h-auto">
                    <h2 class="overflow-hidden font-mono font-black text-center uppercase">BOOKS ARCHIVE</h2>
                    <img aria-hidden="true" class="object-cover w-24 h-16 mx-auto" src="{{ asset('img/logo.png') }}"
                        alt="Office" />
                </div>
